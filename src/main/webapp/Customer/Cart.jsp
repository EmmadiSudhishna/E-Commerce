...
<script language="javascript">
	...
	function confirm_delete(productCode, customerId) {
        ...
        if (ans) {
            window.location = "/EcommerceProject/DeleteCartServlet?productCode=" + productCode +"&customerId="+customerId;
        }
    }
</script>
...
<body>
	...
	<h2 class="text-center text-dark mt-3"><u>CART ITEMS</u></h2>
	  <div class="container"> <!--  style="background-color:; height: 600px; width: 1200px;">-->
		...
		<div class="row">
			...
			<div class="table-responsive">
				<table
					class="table   table-info table-hover table-responsive table-bordered  mt-4"
					id="table_id">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="number" name="gst" id="gst<%=i%>"
								value="<%=gst%>" class="form-control" style="width: 150px"></td>
							...
							<td>
								<!--<a
						  href="/EcommerceProject/DeleteCategory?categoryId=<%=productOb.getProductCode()%>"
