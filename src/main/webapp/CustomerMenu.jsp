...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top"
		...
		<div class="container-fluid">
			...
			<a class="navbar-brand" href="#"> <img src="../uploads/Logo.jpeg"
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav ">
					<li class="nav-item"><a class="nav-link" href="#"
						style="color: white;"><h4>E-commerce</h4></a></li>
				</ul>
				<form class="d-flex mx-auto" action="#">
					<input class="form-control me-2" type="text" placeholder="Search"
						name="search" style="width: 500px;" required>
	...
	<nav class="navbar navbar-expand-xl navbar-dark" style="height: 40px; background-color: rgb(48, 66, 85);">
    <div class="container-fluid">
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      	<span class="navbar-toggler-icon"></span>
    </button>
