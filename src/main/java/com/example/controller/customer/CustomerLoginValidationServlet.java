...
/**
 * Servlet implementation class CustomerLoginValidationServlet
 */
@WebServlet("/CustomerLoginValidationServlet")
public class CustomerLoginValidationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerLoginValidationServlet() {
        super();
