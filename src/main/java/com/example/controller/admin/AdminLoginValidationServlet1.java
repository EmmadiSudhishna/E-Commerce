...
/**
 * Servlet implementation class AdminLoginValidationServlet1
 */
@WebServlet("/AdminLoginValidationServlet1")
public class AdminLoginValidationServlet1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminLoginValidationServlet1() {
        super();
